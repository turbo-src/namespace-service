...
describe("createRepo", function () {
  it("should create a new repo in the database", async function () {
    ...
    const demoRepo2 = await createRepo(
      /*repo_name:*/ "joseph/demoRepo2",
      /*repo_id:*/ "cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc",
      /*repo_signature:*/ "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd",
      /*contributor_id:*/ "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
      /*app:*/ "app2",
      /*repo_uri:*/ "repo_uri",
      /*metadata:*/ "metadata2",
    );
